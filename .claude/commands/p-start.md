...
3. Summarize: branch name, and either the plan or a diff summary. Remind: _review in your IDE, iterate as needed, then run `/p-pr` when the changes are ready to become a PR._
